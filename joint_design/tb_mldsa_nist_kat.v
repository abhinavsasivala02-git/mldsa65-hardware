...
module tb_mldsa_nist_kat;
    ...
    reg [7:0] ref_sig [0:3308];
        ...
        integer k;
        begin
            $readmemh($sformatf("tb/nist/%0d/xi_%0d.mem", i, i), ref_xi);
            $readmemh($sformatf("tb/nist/%0d/pk_%0d.mem", i, i), ref_pk);
            $readmemh($sformatf("tb/nist/%0d/sk_%0d.mem", i, i), ref_sk);
            $readmemh($sformatf("tb/nist/%0d/rnd_%0d.mem", i, i), ref_rnd);
            $readmemh($sformatf("tb/nist/%0d/mu_%0d.mem", i, i), ref_mu);
            $readmemh($sformatf("tb/nist/%0d/sig_%0d.mem", i, i), ref_sig);
        end
    endtask
