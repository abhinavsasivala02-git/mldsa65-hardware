...
module decompose (
    ...
    localparam GAMMA2X2   = 2 * GAMMA2;
    localparam Q_MINUS_1  = `MLDSA_Q - 1;
    ...
    always @(*) begin
        ...
        // diff = r+ - r0  (mod 2^(MLDSA_QBITS+1)): a multiple of 2*gamma2 in [0, 15*2*gamma2]
        diff = r_plus - r0_tmp;

        // Map centred remainder to [0, Q): add Q when negative
        r0_m = {1'b0, r0_tmp};
