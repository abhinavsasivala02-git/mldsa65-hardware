# =============================================================================
# vivado_verify.tcl - ML-DSA-65 Verify KAT simulation (Vivado 2023.2)
# =============================================================================
set top tb_mldsa_verify_kat
...
puts "=== STEP 3: xelab ==="
if {[catch {exec xelab -debug typical -L xsim xsim.tb_mldsa_verify_kat -s verify_sim} err]} {
...
puts "=== STEP 4: xsim ==="
if {[catch {exec xsim -R verify_sim} err]} {
    puts "ERROR: xsim failed:\n$err"
    exit 1
}
puts "=== STEP 4: xsim OK ==="

puts "=== VERIFY SIMULATION COMPLETE ==="
